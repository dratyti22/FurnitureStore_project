...
from .models import EmailMailing, EmailMailingList, UserModel
...
class EmailMailingForm(forms.ModelForm):
    """
    Форма сохранения письма рассылкм
    """
    class Meta:
        model = EmailMailing
